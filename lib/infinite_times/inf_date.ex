defmodule InfiniteTimes.InfDate do
  ...
  @type t :: %__MODULE__{date: %Date{}, finitness: :finite} | %__MODULE__{date: nil, finitness: :infinity | :neg_infinity}
  ...
  def compare(%__MODULE__{finitness: :infinity}, %__MODULE__{finitness: :infinity}),
    do: :eq
  def compare(%__MODULE__{finitness: :infinity}, _),
    do: :gt
  def compare(_, %__MODULE__{finitness: :infinity}),
    do: :lt
  def compare(%__MODULE__{finitness: :neg_infinity}, %__MODULE__{finitness: :neg_infinity}),
    do: :eq
  def compare(%__MODULE__{finitness: :neg_infinity}, _),
    do: :lt
  def compare(_, %__MODULE__{finitness: :neg_infinity}),
    do: :gt
  def compare(%__MODULE__{date: left, finitness: :finite}, %__MODULE__{date: right, finitness: :finite}),
